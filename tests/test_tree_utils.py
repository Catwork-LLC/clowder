...
class TestSequenceStack:
    ...
    def test_unstack_sequence_fields(self, sequence, expected):
        ...
        tree.map_structure(np.testing.assert_array_equal, unstacked, sequence)
...
def test_fast_map_structure():
    ...
    expected_mapped_structure = tree.map_structure(single_arg_map_fn, structure)
    mapped_structure = tree_utils.fast_map_structure(single_arg_map_fn, structure)
    assert mapped_structure == expected_mapped_structure

    expected_double_mapped_structure = tree.map_structure(map_fn, structure, expected_mapped_structure)
    double_mapped_structure = tree_utils.fast_map_structure(map_fn, structure, mapped_structure)
...
def test_fast_map_structure_with_path():
    ...
    expected_mapped_structure = tree.map_structure_with_path(single_arg_map_fn, structure)
    mapped_structure = tree_utils.fast_map_structure_with_path(single_arg_map_fn, structure)
    assert mapped_structure == expected_mapped_structure

    expected_double_mapped_structure = tree.map_structure_with_path(map_fn, structure, mapped_structure)
    double_mapped_structure = tree_utils.fast_map_structure_with_path(map_fn, structure, mapped_structure)
    assert double_mapped_structure == expected_double_mapped_structure
