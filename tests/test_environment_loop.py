...
# Discount specs
F32_2_MIN_0_MAX_1 = BoundedArray(dtype=np.float32, shape=(2,), minimum=0.0, maximum=1.0)
F32_2x1_MIN_0_MAX_1 = BoundedArray(dtype=np.float32, shape=(2, 1), minimum=0.0, maximum=1.0)
...
TEST_CASES_LABEL = [
    "scalar_discount_scalar_reward",
    "vector_discount_scalar_reward",
    "matrix_discount_matrix_reward",
    "tree_discount_tree_reward",
]
...
def _parameterized_setup(discount_spec: Optional[specs.NestedSpec] = None, reward_spec: Optional[specs.NestedSpec] = None):
